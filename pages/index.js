...
export default function Index() {
  const styling = "img.no-mobile {border-style: solid;}@media only screen and (max-width: 500px) {img.no-mobile {display: none;}}"
  return (
    <>
      {/* <IndexNavbar fixed /> */}
      <style>
      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
              ...
              <div>
                <div className="mt-12 md:w-6/36">
                  <a
                    ...
                    target="_blank"
                  >
                    <i class="fa-solid fa-user-group"></i> Get Early access
                  </a>
                </div>
              </div>
        ...
        <img
          className="no-mobile relative top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-48 md:w-32 lg:w-48 sm:mt-0 w-10/12 max-h-860-px"
          src="/img/ReadWriteOwn002.jpg"
          alt="..."
        /> 
      </section>
